...
async function handleImage(relativeSrc, alt, height, width, img_class) {
  ...
  return `<div class="image-wrapper ${img_class}"> <picture> ${sourceWebp} ${sourceJpeg} ${img} </picture> </div>`;
}
